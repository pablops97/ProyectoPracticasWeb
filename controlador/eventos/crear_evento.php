...
if (isset($_SESSION['conectado']) && $_SESSION['conectado']) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "INSERT INTO EVENTO (TITULO_EVENTO, DESCRIPCION_EVENTO, LOCALIZACION, ESTADO, PRECIO, FECHA_INICIO_INSCRIPCION, FECHA_INICIO, FECHA_FIN, IDCATEGORIA, NUMEROMAXPARTICIPANTES, IMAGENEVENTO, IDTECNICO)
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        $stmt = $db->prepare($sql);
        $stmt->bind_param(
            "ssssdssssisi",
